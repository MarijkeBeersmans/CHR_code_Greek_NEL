...
patterns_optimizer = {
    'additional_layers': ['additional'],
    'top_layer': ['additional', 'xlm_roberta_model.encoder.layer.23.'],
    'top4_layers': [
        'additional',
        'xlm_roberta_model.encoder.layer.23.',
        'encoder.layer.22.',
        'encoder.layer.21.',
        'encoder.layer.20.',
    ],
    'all_encoder_layers': ['additional', 'xlm_roberta_model.encoder.layer'],
    'all': ['additional', 'xlm_roberta_model.encoder.layer', 'xlm_roberta_model.embeddings'],
}

def get_xlm_roberta_optimizer(models, type_optimization, learning_rate, fp16=False):
    """ Optimizes the network with AdamWithDecay
    """
    if type_optimization not in patterns_optimizer:
        print(
