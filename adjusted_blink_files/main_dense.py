...
def run(
    ...
    while not stopping_condition:
        ...
        context_input, candidate_input, label_input = prepare_crossencoder_data(
            crossencoder.tokenizer, samples, labels, nns, id2title, id2text, keep_all, biencoder_params["max_context_length"]
        )
        ...
        dataloader = _process_crossencoder_dataloader(
            context_input_modified, label_input, crossencoder_params
        )
